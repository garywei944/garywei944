...
Hi GitHub! Here's **Gary**! I'm a Machine Learning Engineer [@ByteDance](https://www.bytedance.com/), as well as an ex-Research-Assistant in Machine Learning Systems, AI for Science, and High-Performance Computing (HPC) [@Cornell](https://www.cornell.edu/).
...
I see myself as a mix of Engineer and Researcher, combining deep theoretical insights with practical, hands-on problem solving and system design.
I studied Computer Science (as a subject of Science) and Mathematics.
...
I was a **PROUD** Arch Linux user.
Now I turned to CachyOS(Arch-based) for extreme performance and optimization.
I care about scalable, theoretically sound, and efficient systems.
...
- **OS**:
  [![CachyOS](https://img.shields.io/badge/CachyOS-latest-ccff66?logo=Linux&logoColor=white)](https://github.com/garywei944/eva_arch)
